...
<table cellpadding="3" style="font-weight: bold;">
  <tr>
    ...
    <td>:</td>
    <td><input type="text" class="form-control" name="nama_siswa" value="<?=$d['nama_siswa'] ?>"></td>
  </tr>
  <tr>
    <td>NIS/NISN</td>
    <td>:</td>
  ...
  <tr>
    ...
    <td>:</td>
    <td><input type="text" class="form-control" name="tempat_lahir" value="<?=$d['tempat_lahir'] ?>"></td>
    <td>/</td>
    <td><input type="date" class="form-control" name="tgl_lahir" value="<?=$d['tgl_lahir'] ?>"></td>
  </tr>
  <tr>
    <td>Jenis Kelamin </td>
    <td>:</td>
  ...
  <tr>
   ...
   <tr>
    <td>Tahun Masuk</td>
    <td>:</td>
    <td><input name="th_angkatan" type="text" class="form-control" value="<?=$d['th_angkatan'] ?>"></td>
  </tr>
  <tr>
    <td>Pas Foto</td>
    <td>:</td>
